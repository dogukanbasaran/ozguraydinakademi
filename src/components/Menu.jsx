...
const Menu = () => {
  return (
     <div className="flex gap-12 font-heading font-semibold text-neutral-800 whitespace-nowrap uppercase" id="menu">
        ...
        <NavLink to="/about" className="hover:text-neutral-500  xl:text-[16px] hidden lg:block">Hakkında</NavLink>
        <NavLink to="/packages" className="hover:hover:text-neutral-500  xl:text-[16px] hidden lg:block">Paketler</NavLink>
