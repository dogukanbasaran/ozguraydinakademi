...
const Intro = () => {
  return (
    ...
    <section id='introduction' className='flex flex-col space-y-12 md:space-y-0 md:flex-row h-full w-full md:max-w-7xl px-5  mb-20 mx-auto justify-center mt-[150px]'>
         {/* INTRO LEFT CONTENT */}
