...
const Intro = () => {
  return (
    ...
    <section id='introduction' className='flex flex-col space-y-12 md:space-y-0 md:flex-row h-full w-full md:max-w-7xl px-5  mb-[150px] mt-[100px] sm:mt-[150px] mx-auto justify-center'>
         {/* INTRO LEFT CONTENT */}
