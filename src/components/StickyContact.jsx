...
import {FaThreads, FaEnvelope} from "react-icons/fa6"
...
const StickyContact = () => {
  return (
    <>
    <div className='hidden sm:block h-[300px] w-[60px] rounded-l-xl bg-gray-800 text-white border-t border-b border-l fixed  top-[150px] right-0 z-50'>
            ...
            <div className='h-[50px] border-b  flex justify-center items-center cursor-pointer hover:text-gray-300 hover:scale-105 duration-300'>
                <a href='mailto:ozguraydinakademi@gmail.com'><FaEnvelope className='w-full text-[35px]'/></a>
            </div>
