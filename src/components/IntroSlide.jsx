    ...
    <section id='introduction'>
      <div className='container h-[auto] py-10'>
        ...
        <div id='intro-btn' className='flex justify-center gap-2'>
              <button className='bg-gray-800 text-neutral-300 font-text font-semib px-12 py-2 hover:bg-gray-300 hover:text-neutral-800'>Paketlere Göz At</button>
              <button className='bg-gray-800 text-neutral-300 font-text font-semib px-12 py-2 hover:bg-gray-300 hover:text-neutral-800'>İletişime Geç</button>
        </div>
      </div>
